...
5. A code-generated candidate writes back as a candidate or review event, never as source-closed proof.
6. Hash, revision, source species, proof tier, and native locator should survive round trips.
7. Conflicting source versions remain separate members of a source family.
8. Superseded conclusions remain visible and point to replacements.
